...
GLWidget2d1::GLWidget2d1(QWidget *parent) :   QGLWidget(parent)
{
...
void GLWidget2d1::initializeGL(){
    qglClearColor(Qt::black);
}

void GLWidget2d1::paintGL(){
    ...
    for (int i=0; i<=N; i++){
        glVertex2f(fx1(t),fy1(Points[i][1]));
        t+=tau;
    }
            glEnd();
...
void GLWidget2d1::resizeGL(int w, int h){
